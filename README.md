...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-modules-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13340&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-modules-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-modules` can be installed with:

```
conda install r-modules
```

It is possible to list all of the versions of `r-modules` available on your platform with:
